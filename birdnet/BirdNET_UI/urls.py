...
urlpatterns = [
    ...
    path('download_database_ebirds/', views.download_database_ebirds, name='download_database_ebirds'),
    ...
    path('api/ebirds_extra/', views.get_ebirds_extra, name='get_ebirds_extra'),
    path('api/ebirds_extra/<str:scientific_name>/', views.get_ebird_extra_by_scientific_name, name='get_ebird_extra_by_scientific_name'),
]